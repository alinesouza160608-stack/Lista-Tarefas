...
//JSON.stringify() transforma nosso array de tarefas em uma string para pode ser guardado.
function saveTasks(){
...
tasks.forEach((taskText, index) => {
    ...
    removeBtn.innerHTML = '🗑'; //ícone de lixeira
    removeBtn.onclick = () => removeTask(index);
     
 
    //adicionar os elementos na estrutura:<span> e botões dentro do <li>
...
//Função para remiver uma tarefa
/**
...
function removeTask(index){
    ...
    // O código dentro do 'if' só será executdo se o usuário clicar em "OK".
    if (confirm(confirmationMessage)){
        //Se o usário confirmou (clicou em "OK"):
...
function editTask(index){
    ...
    const newTaskText = prompt ('🏢 Edite sua tarefa: ', currentTask); //Abre uma caixa de diáogo
